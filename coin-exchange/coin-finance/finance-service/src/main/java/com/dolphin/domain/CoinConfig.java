...
public class CoinConfig {
    ...
    public static final String COL_CREDIT_LIMIT = "credit_limit";

    public static final String COL_CREDIT_MAX_LIMIT = "credit_max_limit";

    public static final String COL_RPC_IP = "rpc_ip";

    public static final String COL_RPC_PORT = "rpc_port";

    public static final String COL_RPC_USER = "rpc_user";

    public static final String COL_RPC_PWD = "rpc_pwd";

    public static final String COL_LAST_BLOCK = "last_block";

    public static final String COL_WALLET_USER = "wallet_user";

    public static final String COL_WALLET_PASS = "wallet_pass";

    public static final String COL_CONTRACT_ADDRESS = "contract_address";

    public static final String COL_CONTEXT = "context";

    public static final String COL_MIN_CONFIRM = "min_confirm";

    public static final String COL_TASK = "task";

    public static final String COL_STATUS = "status";

    public static final String COL_AUTO_DRAW_LIMIT = "auto_draw_limit";

    public static final String COL_AUTO_DRAW = "auto_draw";
}