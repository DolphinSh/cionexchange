...
4异常单
    ...
    public static final String COL_MERGE_LOW_PRICE = "merge_low_price";

    public static final String COL_MERGE_HIGH_PRICE = "merge_high_price";
    ...
    public static final String COL_DEAL = "deal";

    public static final String COL_FREEZE = "freeze";

    public static final String COL_MARGIN_RATE = "margin_rate";

    public static final String COL_BASE_COIN_RATE = "base_coin_rate";

    public static final String COL_PRICE_COIN_RATE = "price_coin_rate";
    ...
    public static final String COL_OPEN_ORDER_ID = "open_order_id";
